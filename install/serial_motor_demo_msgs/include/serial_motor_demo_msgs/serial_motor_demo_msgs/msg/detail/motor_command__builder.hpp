...
class Init_MotorCommand_linear_velocity
{
public:
  explicit Init_MotorCommand_linear_velocity(::serial_motor_demo_msgs::msg::MotorCommand & msg)
  : msg_(msg)
  {}
  ::serial_motor_demo_msgs::msg::MotorCommand linear_velocity(::serial_motor_demo_msgs::msg::MotorCommand::_linear_velocity_type arg)
  {
...
class Init_MotorCommand_angular_velocity
{
public:
  explicit Init_MotorCommand_angular_velocity(::serial_motor_demo_msgs::msg::MotorCommand & msg)
  : msg_(msg)
  {}
  Init_MotorCommand_linear_velocity angular_velocity(::serial_motor_demo_msgs::msg::MotorCommand::_angular_velocity_type arg)
  {
    msg_.angular_velocity = std::move(arg);
    return Init_MotorCommand_linear_velocity(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_MotorCommand_angular_velocity mot_2_req_rad_sec(::serial_motor_demo_msgs::msg::MotorCommand::_mot_2_req_rad_sec_type arg)
  {
    msg_.mot_2_req_rad_sec = std::move(arg);
    return Init_MotorCommand_angular_velocity(msg_);
  }
